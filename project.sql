...
CREATE TABLE `Book` (
  ...
  KEY `S_idx` (`Sno`),
  CONSTRAINT `Sno` FOREIGN KEY (`Sno`) REFERENCES `Shelf` (`Sno`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `BorrowRecord` (
  ...
  KEY `Rno_idx` (`Rno`),
  KEY `Bno_idx` (`Bno`),
  CONSTRAINT `Bno` FOREIGN KEY (`Bno`) REFERENCES `BookForRent` (`Bno`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Rno` FOREIGN KEY (`Rno`) REFERENCES `Reader` (`Rno`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Reader` VALUES ('20160000','1234','lwd','1996-05-17',0,'computer science',5,0),('20160001','1234','cy','1996-05-16',0,'computer science',5,0),('20160002','1234','clz','1996-05-15',1,'computer science',5,0);
...
CREATE TABLE `ReturnRecord` (
  `RRno` varchar(8) NOT NULL,
  `operNo` varchar(8) NOT NULL,
  `BRno` varchar(8) NOT NULL COMMENT 'FK of BorrowRecord',
  `returnTime` datetime NOT NULL,
  PRIMARY KEY (`RRno`),
  UNIQUE KEY `RRno_UNIQUE` (`RRno`),
  KEY `BRno_idx` (`BRno`),
  CONSTRAINT `BRno` FOREIGN KEY (`BRno`) REFERENCES `BorrowRecord` (`BRno`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-01 10:54:59
